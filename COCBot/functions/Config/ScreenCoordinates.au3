...
Global $aArmyCampSize[2] = [395, 240] ; Training Window, Overview screen, Current Size/Total Size
...
Global $aIsTrainPgChk1[4] = [760, 180, 0x59514B, 10] ; Main Screen, Train page open - left upper corner of x button. Updated 16.0.4
