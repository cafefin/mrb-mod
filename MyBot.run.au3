...
;#include "COCBot\Wightman__MOD\config\ScreenCoordinates.au3"
#include "COCBot\Wightman__MOD\config\ImageDirectories.au3"
...
Func SetupFilesAndFolders()
	...
	DirCreate($g_sProfileTempDebugDOCRPath) ; Dissociable
